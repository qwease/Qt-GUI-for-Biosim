...
void ParamManager::setDefaults()
{
    ...
    privParams.graphLogUpdateCommand = "/usr/bin/gnuplot --persist ./tools/survival-plot.gp && /usr/bin/gnuplot --persist ./tools/diversity-plot.gp";
    privParams.parameterChangeGenerationNumber = 0;
}


void ParamManager::registerConfigFile(QString filename)
{
